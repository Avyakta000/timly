  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
      ...
      <div className="rounded-lg p-8 max-w-xl w-full text-center">
        <h1 className="text-4xl font-semibold text-indigo-500 mb-4">
        ...
        <div className="flex justify-center space-x-6">
          <Link
            to="/dashboard"
            className="bg-indigo-500 text-white py-2 px-6 rounded-md text-lg hover:bg-indigo-700 transition duration-300"
          >
            Get Started
          </Link>
          <Link
          to={"https://easymanage.quicklit.in"}
            className="bg-transparent border-2 border-indigo-500 text-indigo-500 py-2 px-6 rounded-md text-lg hover:bg-indigo-600 hover:text-white transition duration-300"
          >
            Learn More
          </Link>
        </div>
